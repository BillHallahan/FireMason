...
(assert (= (chain-length 0) 8))
(assert (= (chain-length 1) 3))
(assert (= (chain-length 3) 4))
(assert (= (chain-length 4) 3))
(assert (= (chain-length 5) 8))
(assert (= (chain-length 6) 4))
(assert (= (chain-length 8) 4))
(assert (= (chain-length 9) 4))
