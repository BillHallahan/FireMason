...
(assert (= (chain-length 0) 11))(assert (= (chain-length 1) 3))(assert (= (chain-length 5) 12))(assert (= (chain-length 6) 3))(assert (= (chain-length 2) 0))(assert (= (chain-length 3) 0))(assert (= (chain-length 4) 0))
...
(assert (= (rule-target 5 6) DROP))
(assert (=> (matches-rule 0 5 6) (and (not (reaches 0 5 7))(= (terminates-with 0) DROP))))
(assert (=> (matches-rule 1 5 6) (and (not (reaches 1 5 7))(= (terminates-with 1) DROP))))
...
(assert (= (rule-target 5 8) DROP))
(assert (=> (matches-rule 0 5 8) (and (not (reaches 0 5 9))(= (terminates-with 0) DROP))))
(assert (=> (matches-rule 1 5 8) (and (not (reaches 1 5 9))(= (terminates-with 1) DROP))))


(assert (= (rule-target 5 9) DROP))
(assert (=> (matches-rule 0 5 9) (and (not (reaches 0 5 10))(= (terminates-with 0) DROP))))
(assert (=> (matches-rule 1 5 9) (and (not (reaches 1 5 10))(= (terminates-with 1) DROP))))


(assert (= (rule-target 5 10) (GO 6 0)))
(assert (=> (matches-rule 0 5 10) (and (reaches 0 6 0)(= (returns-from 0 6) (reaches 0 5 11)))))
(assert (=> (matches-rule 1 5 10) (and (reaches 1 6 0)(= (returns-from 1 6) (reaches 1 5 11)))))
(assert (=> (not (matches-rule 0 5 10)) (not (reaches 0 6 0))))
(assert (=> (not (matches-rule 1 5 10)) (not (reaches 1 6 0))))

(assert (= (rule-target 5 11) DROP))
(assert (=> (matches-rule 0 5 11) (and (not (reaches 0 5 12))(= (terminates-with 0) DROP))))
(assert (=> (matches-rule 1 5 11) (and (not (reaches 1 5 12))(= (terminates-with 1) DROP))))


(assert (= (rule-target 6 0) ACCEPT))
(assert (=> (matches-rule 0 6 0) (and (not (reaches 0 6 1))(= (terminates-with 0) ACCEPT))))
(assert (=> (matches-rule 1 6 0) (and (not (reaches 1 6 1))(= (terminates-with 1) ACCEPT))))
...
(assert (=> 
   (and (reaches 0 5 8) (= (rule-target 5 8) NONE)) 
    ...
    (and (<= 1 9) (reaches 0 5 9))
    (reaches 0 5 (- 9 1))
))

(assert (=> 
    (and (reaches 0 5 9) (not (matches-criteria 0 5 9))) 
    (reaches 0 5 (+ 9 1))
))

(assert (=> 
   (and (reaches 0 5 9) (= (rule-target 5 9) NONE)) 
    (reaches 0 5 (+ 9 1))
))(assert (=> 
    (and (<= 1 10) (reaches 0 5 10))
    (reaches 0 5 (- 10 1))
))

(assert (=> 
    (and (reaches 0 5 10) (not (matches-criteria 0 5 10))) 
    (reaches 0 5 (+ 10 1))
))

(assert (=> 
   (and (reaches 0 5 10) (= (rule-target 5 10) NONE)) 
    (reaches 0 5 (+ 10 1))
))(assert (=> 
    (and (<= 1 11) (reaches 0 5 11))
    (reaches 0 5 (- 11 1))
))

(assert (=> 
    (and (reaches 0 5 11) (not (matches-criteria 0 5 11))) 
    (reaches 0 5 (+ 11 1))
))

(assert (=> 
   (and (reaches 0 5 11) (= (rule-target 5 11) NONE)) 
    (reaches 0 5 (+ 11 1))
))(assert (=> 
    (and (<= 1 12) (reaches 0 5 12))
    (reaches 0 5 (- 12 1))
))

(assert (=> 
    (and (reaches 0 5 12) (not (matches-criteria 0 5 12))) 
    (reaches 0 5 (+ 12 1))
))

(assert (=> 
   (and (reaches 0 5 12) (= (rule-target 5 12) NONE)) 
    (reaches 0 5 (+ 12 1))
))(assert (=> 
...
(assert (=> 
   (and (reaches 1 5 8) (= (rule-target 5 8) NONE)) 
    ...
    (and (<= 1 9) (reaches 1 5 9))
    (reaches 1 5 (- 9 1))
))

(assert (=> 
    (and (reaches 1 5 9) (not (matches-criteria 1 5 9))) 
    (reaches 1 5 (+ 9 1))
))

(assert (=> 
   (and (reaches 1 5 9) (= (rule-target 5 9) NONE)) 
    (reaches 1 5 (+ 9 1))
))(assert (=> 
    (and (<= 1 10) (reaches 1 5 10))
    (reaches 1 5 (- 10 1))
))

(assert (=> 
    (and (reaches 1 5 10) (not (matches-criteria 1 5 10))) 
    (reaches 1 5 (+ 10 1))
))

(assert (=> 
   (and (reaches 1 5 10) (= (rule-target 5 10) NONE)) 
    (reaches 1 5 (+ 10 1))
))(assert (=> 
    (and (<= 1 11) (reaches 1 5 11))
    (reaches 1 5 (- 11 1))
))

(assert (=> 
    (and (reaches 1 5 11) (not (matches-criteria 1 5 11))) 
    (reaches 1 5 (+ 11 1))
))

(assert (=> 
   (and (reaches 1 5 11) (= (rule-target 5 11) NONE)) 
    (reaches 1 5 (+ 11 1))
))(assert (=> 
    (and (<= 1 12) (reaches 1 5 12))
    (reaches 1 5 (- 12 1))
))

(assert (=> 
    (and (reaches 1 5 12) (not (matches-criteria 1 5 12))) 
    (reaches 1 5 (+ 12 1))
))

(assert (=> 
   (and (reaches 1 5 12) (= (rule-target 5 12) NONE)) 
    (reaches 1 5 (+ 12 1))
))(assert (=> 
...
(assert (= (= protocol 124) (matches-criteria 0 5 0)))
(assert (= (= protocol 124) (matches-criteria 1 5 0)))

(assert (= (and (= protocol 6) (and SYN (not ACK))) (matches-criteria 0 5 1)))
(assert (= (and (= protocol 6) (and SYN (not ACK))) (matches-criteria 1 5 1)))

(assert (= (and (= protocol 6) RST) (matches-criteria 0 5 2)))
(assert (= (and (= protocol 6) RST) (matches-criteria 1 5 2)))

(assert (= (and (= protocol 6) (= source_port 37)) (matches-criteria 0 5 3)))
(assert (= (and (= protocol 6) (= source_port 37)) (matches-criteria 1 5 3)))

(assert (= (and (= protocol 6) (= destination_port 49)) (matches-criteria 0 5 4)))
(assert (= (and (= protocol 6) (= destination_port 49)) (matches-criteria 1 5 4)))

(assert (= (and (= protocol 6) (= destination_port 48)) (matches-criteria 0 5 5)))
(assert (= (and (= protocol 6) (= destination_port 48)) (matches-criteria 1 5 5)))

(assert (= (and (= protocol 17) (= destination_port 49)) (matches-criteria 0 5 6)))
(assert (= (and (= protocol 17) (= destination_port 49)) (matches-criteria 1 5 6)))

(assert (= (and (= protocol 17) (= destination_port 48)) (matches-criteria 0 5 7)))
(assert (= (and (= protocol 17) (= destination_port 48)) (matches-criteria 1 5 7)))

(assert (= (and (= protocol 17) (= destination_port 46)) (matches-criteria 0 5 8)))
(assert (= (and (= protocol 17) (= destination_port 46)) (matches-criteria 1 5 8)))

(assert (= (and (= protocol 17) (= destination_port 47)) (matches-criteria 0 5 9)))
(assert (= (and (= protocol 17) (= destination_port 47)) (matches-criteria 1 5 9)))

(assert (matches-criteria 0 5 10))
(assert (matches-criteria 1 5 10))

(assert (= (and (= protocol 6) URG) (matches-criteria 0 5 11)))
(assert (= (and (= protocol 6) URG) (matches-criteria 1 5 11)))

(assert (= (= protocol 117) (matches-criteria 0 6 0)))
(assert (= (= protocol 117) (matches-criteria 1 6 0)))

(assert (= (= protocol 6) (matches-criteria 0 6 1)))
(assert (= (= protocol 6) (matches-criteria 1 6 1)))

(assert (= (= protocol 17) (matches-criteria 0 6 2)))
(assert (= (= protocol 17) (matches-criteria 1 6 2)))

(assert (or (and (= chain0 0)(= chain1 5))))
(assert (reaches 0 chain0 0))
(assert (reaches 1 chain1 0))
(assert (not (and (or (= (terminates-with 0) (terminates-with 1))(and (reaches-end 0 chain0)(reaches-end 1 chain1))(and (= protocol 124)(or (reaches 1 5 0))))(=> (and (= protocol 124)(or (reaches 1 5 0))) (= (terminates-with 1) DROP)))))
(check-sat)
(get-model)