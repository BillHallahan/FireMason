...
iptables -A bad-ports -p 6 --dport 78 -j DROP
iptables -A bad-ports -p 17 --dport 78 -j DROP
iptables -A bad-ports -p 6 --tcp-flags SYN,ACK NONE -j DROP
...
iptables -A bad-ports -p 6 --dport 4 -j ACCEPT
iptables -A bad-ports -p 6 --dport 89 -j ACCEPT
...
$IPTABLES -N check
$IPTABLES -F check
iptables -A check ! -p 4  -j DROP
$IPTABLES -p 0 -j DROP  -A check
$IPTABLES -A check -p tcp --tcp-flags SYN SYN -j ACCEPT

$IPTABLES -N end
$IPTABLES -F end
iptables -A end -p 37 -p 6 --sport 97 -j ACCEPT
iptables -A end -p 37 -p 17 --sport 97 -j ACCEPT
iptables -A end -p 1 -p 6 --dport 45 ! --sport 90  -j ACCEPT
iptables -A end -p 1 -p 17 --dport 45 ! --sport 90  -j ACCEPT
...
$IPTABLES -N ret
$IPTABLES -F ret
iptables -A ret -p 17 --dport 4 -j ACCEPT
iptables -A ret -p 17 --dport 89 -j ACCEPT
iptables -A ret -p 6 --tcp-flags ACK,SYN ACK -j ACCEPT
